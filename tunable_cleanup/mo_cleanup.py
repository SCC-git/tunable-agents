...
def training_episode(render=False):
    ...
    print("\rEpisode: {}, Time: {}, Reward1: {}, Apples1: {}, Cleans1: {}, Avg Reward1: {}, eps: {:.3f}".format(
        episode, datetime.now() - start_time, ep_rewards[0], agent1_episode_apples, agent1_episode_cleans, av_rewards[0], eps), end="")
