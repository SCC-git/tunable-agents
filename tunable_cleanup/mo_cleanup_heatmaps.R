...
ggplot(data) +
  geom_tile(aes(x=1 - `Competitive 1`/0.4, y=1 - `Competitive 2`/0.4, fill=`Agent 1 Clean`/250)) +
...
ggsave('./tunable-agents/tunable_cleanup/results/cleanup_heatmap210421.png')
#```
